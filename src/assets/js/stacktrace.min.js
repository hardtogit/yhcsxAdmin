        ...
        function(e, n, t) {
          ...
          (t.encode = function(e) {
            var n,
              t = '',
              o = r(e);
            do (n = o & u), (o >>>= a), o > 0 && (n |= c), (t += i.encode(n));
            while (o > 0);
            return t;
          }),
            (t.decode = function(e, n, t) {
              var r,
                s,
                l = e.length,
                f = 0,
              ...
              do {
                ...
                if (((s = i.decode(e.charCodeAt(n++))), -1 === s))
        ...
        function(e, n, t) {
          ...
          (t.GREATEST_LOWER_BOUND = 1),
            ...
            (t.search = function(e, n, o, i) {
              ...
              var a = r(-1, n.length, e, n, o, i || t.GREATEST_LOWER_BOUND);
              if (0 > a) return -1;
          ...
          function i(e, n, t, a) {
            if (a > t) {
              var s = o(t, a),
                u = t - 1;
              r(e, s, a);
              for (var c = e[a], l = t; a > l; l++) n(e[l], c) <= 0 && ((u += 1), r(e, u, l));
              r(e, u + 1, l);
              var f = u + 1;
              i(e, n, t, f - 1), i(e, n, f + 1, a);
            }
          }
          t.quickSort = function(e, n) {
            i(e, n, 0, e.length - 1);
          };
        },
        {},
      ...
      7: [
        function(e, n, t) {
          ...
          function a(e) {
            ...
            this._sections = o.map(function(e) {
              ...
              return (
                (i = n),
                {
                  generatedOffset: { generatedLine: t + 1, generatedColumn: o + 1 },
          ...
          (r.fromSourceMap = function(e) {
            ...
            (r.prototype.eachMapping = function(e, n, t) {
              var o,
                i = n || null,
            ...
            (r.prototype.allGeneratedPositionsFor = function(e) {
              ...
              if (
                (null != this.sourceRoot && (t.source = s.relative(this.sourceRoot, t.source)),
            ...
            (o.prototype._parseMappings = function(e, n) {
              for (
                ...
                if (';' === e.charAt(_)) c++, _++, (p = 0);
                  ...
                  (t.generatedColumn = p + o[0]),
                    (p = t.generatedColumn),
                    o.length > 1 &&
                      ((t.source = m + o[1]),
                      (m += o[1]),
                      (t.originalLine = g + o[2]),
                      (g = t.originalLine),
                      (t.originalLine += 1),
                      (t.originalColumn = h + o[3]),
                      (h = t.originalColumn),
                      o.length > 4 && ((t.name = d + o[4]), (d += o[4]))),
                    C.push(t),
                    'number' == typeof t.originalLine && b.push(t);
                }
            ...
            (o.prototype.sourceContentFor = function(e, n) {
              ...
              if (null != this.sourceRoot && (t = s.urlParse(this.sourceRoot))) {
                ...
                if ('file' == t.scheme && this._sources.has(r))
            ...
            (a.prototype.originalPositionFor = function(e) {
              ...
              return r
                ? r.consumer.originalPositionFor({
                    ...
                    column:
                      n.generatedColumn -
                      (r.generatedOffset.generatedLine === n.generatedLine
            ...
            (a.prototype._parseMappings = function(e, n) {
              ...
              for (var t = 0; t < this._sections.length; t++)
                for (
                  var r = this._sections[t], o = r.consumer._generatedMappings, i = 0;
                  i < o.length;
                  i++
                ) {
                  var a = o[i],
      ...
      8: [
        function(e, n, t) {
          ...
          function a(e) {
            ...
            return (n = u.join('/')), '' === n && (n = s ? '/' : '.'), r ? ((r.path = n), i(r)) : n;
          }
          function s(e, n) {
            '' === e && (e = '.'), '' === n && (n = '.');
            var t = o(n),
              r = o(e);
            if ((r && (e = r.path || '/'), t && !t.scheme)) return r && (t.scheme = r.scheme), i(t);
            if (t || n.match(_)) return n;
            if (r && !r.host && !r.path) return (r.host = n), i(r);
              ...
              backtrace: function(n) {
                ...
                for (var o = arguments.callee; o && t.length < r; ) {
                  ...
                  /function(?:\s+([\w$]+))+\s*\(/.test(o.toString())
                    ? t.push(new e(RegExp.$1 || void 0, i))
                    : t.push(new e(void 0, i));
                  try {
                    o = o.caller;
                  } catch (s) {
                    break;
        ...
        function(n, t, r) {
          !(function(o, i) {
            ...
            'function' == typeof e && e.amd
              ...
              : 'object' == typeof r
                ? (t.exports = i(n('source-map/lib/source-map-consumer'), n('stackframe')))
                  ...
                  (r.onreadystatechange = function() {
                    4 === r.readyState &&
                      (r.status >= 200 && r.status < 300
                        ? n(r.responseText)
                        : t(new Error('HTTP status: ' + r.status + ' retrieving ' + e)));
                  }),
                  r.send();
              });
            }
                          ...
                          this._get(e.fileName)
                            .then(function(r) {
                              var o = e.lineNumber,
                                a = e.columnNumber,
                                s = i(r, o, a);
                              t(s ? new n(s, e.args, e.fileName, o, a) : e);
                            }, r)
                            ['catch'](r);
                      }.bind(this)
                    );
                                ...
                                this._get(s)
                                  .then(function(t) {
                                    ...
                                    'string' == typeof t && (t = o(t.replace(/^\)\]\}'/, ''))),
                                      'undefined' == typeof t.sourceRoot && (t.sourceRoot = f),
                                      n(c(t, e.args, i, a, r));
                                  }, t)
                                  ['catch'](t);
                            }.bind(this),
          ...
          !(function(o, i) {
            ...
            return {
              ...
              generateArtificially: function(e) {
                ...
                var t = n.backtrace(e);
                return (
                  'function' == typeof e.filter && (t = t.filter(e.filter)), Promise.resolve(t)
                );
              },
                    ...
                    (i.onreadystatechange = function() {
                      4 === i.readyState &&
                        (i.status >= 200 && i.status < 400
                          ? r(i.responseText)
                          : o(new Error('POST to ' + n + ' failed with status: ' + i.status)));
                    }),
                    i.open('post', n),
                    i.setRequestHeader('Content-Type', 'application/json');
                  var a = { stack: e };
                  void 0 !== t && (a.message = t), i.send(JSON.stringify(a));
                });
              },
            };
          });
        },
        { 'error-stack-parser': 1, 'stack-generator': 10, 'stacktrace-gps': 12 },
      ],
    },
    {},
    [13]
